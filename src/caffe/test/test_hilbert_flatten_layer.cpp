...
class HilbertFlattenLayerTest : public MultiDeviceTest<TypeParam> {
  typedef typename TypeParam::Dtype Dtype;
 protected:
  HilbertFlattenLayerTest()
  ...
  virtual ~HilbertFlattenLayerTest() { delete blob_bottom_; delete blob_top_; }
...
TYPED_TEST_CASE(HilbertFlattenLayerTest, TestDtypesAndDevices);

TYPED_TEST(HilbertFlattenLayerTest, TestSetup) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  HilbertFlattenLayer<Dtype> layer(layer_param);
...
TYPED_TEST(HilbertFlattenLayerTest, TestSetupWithAxis) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
...
TYPED_TEST(HilbertFlattenLayerTest, TestSetupWithEndAxis) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
...
TYPED_TEST(HilbertFlattenLayerTest, TestSetupWithStartAndEndAxis) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
...
TYPED_TEST(HilbertFlattenLayerTest, TestForward) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  HilbertFlattenLayer<Dtype> layer(layer_param);
  layer.SetUp(this->blob_bottom_vec_, this->blob_top_vec_);
...
TYPED_TEST(HilbertFlattenLayerTest, TestGradient) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  HilbertFlattenLayer<Dtype> layer(layer_param);
