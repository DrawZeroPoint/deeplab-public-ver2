#ifndef CAFFE_HILBERT_FLATTEN_LAYER_HPP_
#define CAFFE_HILBERT_FLATTEN_LAYER_HPP_
...
/**
 * @brief Reshapes the input Blob into flat vectors using Hilbert curve.
 *
...
class HilbertFlattenLayer : public Layer<Dtype> {
 public:
  explicit HilbertFlattenLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "HilbertFlatten"; }
...
#endif // HILBERT_FLATTEN_LAYER_HPP_
